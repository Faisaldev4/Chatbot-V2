...
/*m.reply = {
     ...
     /*      async value(jid, text = '', quoted, options) {
               ...
               ///BY ZYKO MD
                // IG: @zzyko_04 
  m.reply = async (text, quoted, chatId, options) => {
...
if (m.msg && m.msg.url) {
    m.download = () => conn.downloadM(m.msg, m.mtype.toLowerCase().replace(/message/i, ''));
}
     ...
     * @param {Object} options
     */
//bebas isi apa aja yang penting jangan hati kuu
